 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();class Br{constructor(e,t,n,i){this.id=e,this.username=t,this.message=n,this.deletable=i}createMessageElement(){const e=document.createElement("div"),t=document.createElement("p"),n=document.createElement("p");if(e.classList.add("message-wrapper"),t.classList.add("user-name"),n.classList.add("message"),n.innerText=this.message,t.innerText=this.username,e.append(t),this.deletable){const t=document.createElement("button");t.innerText="X",e.append(t),t.addEventListener("click",(()=>{Gr(this.id)}))}return e.append(n),e}}const zr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyD4HKVGcWT7aG8kJ8yB0M3nsdxT9uxoVWM",authDomain:"chatt-9a0d1.firebaseapp.com",databaseURL:"https://chatt-9a0d1-default-rtdb.europe-west1.firebasedatabase.app",projectId:"chatt-9a0d1",storageBucket:"chatt-9a0d1.appspot.com",messagingSenderId:"389837837818",appId:"1:389837837818:web:a41c54e26707beef818043"})),Vr=Rr(zr,"/messages/");function $r(e){qr(Vr,(t=>{const n=function(e,t){Object.keys(e).length>=25&&Gr(Object.keys(e)[0]);const n=[];for(const i in e){const{username:s,message:r}=e[i],o=t===s;n.push(new Br(i,s,r,o))}return n}(t.val(),e);!function(e){const t=document.querySelector("#messages");t.innerHTML="";for(const n of e)t.append(n.createMessageElement());t.scrollTop=t.scrollHeight}(n)}))}function Yr(e,t){const n={message:e,username:t},i={};i[function(e,t){e=R(e),Ys("push",e._path),Bs("push",t,e._path,!0);const n=ir(e._repo),i=wn(n),s=Dr(e,i),r=Dr(e,i);let o;return o=null!=t?Ar(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}(Vr).key]=n,Mr(Vr,i)}function Gr(e){!function(e){Ys("remove",e._path),Ar(e,null)}(Rr(zr,"/messages/"+e))}const Kr=document.querySelector("#username button"),Qr=document.querySelector("#chat button");Kr.addEventListener("click",(function(e){e.preventDefault();const t=document.querySelector("#username input");t.value&&(Xr=t.value,t.value="");(function(e){document.querySelector("#chat textarea").placeholder=`${e} says...`;const t=document.querySelector("#username"),n=document.querySelector("#chat");t.style.display="none",n.style.display="block"})(Xr),$r(Xr)})),Qr.addEventListener("click",(function(e){e.preventDefault();const t=document.querySelector("#chat textarea"),n=t.value;t.value="",Yr(n,Xr)}));let Xr="Anonymous";
//# sourceMappingURL=index.e548b353.js.map
